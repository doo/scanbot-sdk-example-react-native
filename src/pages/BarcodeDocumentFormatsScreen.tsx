      ...
      <SafeAreaView>
        <View style={Styles.INSTANCE.barcodeDocumentFormats.headerItemContainer}>
            ...
            <Switch
              ...
              onValueChange={(_) => {
                BarcodeDocumentFormats.isFilteringEnabled = !BarcodeDocumentFormats.isFilteringEnabled;
                this.refresh();
              }}
            />
        </View>
        <FlatList
          ...
          renderItem={({item}) => (
            <TouchableOpacity activeOpacity={.6} onPress={() => this.onListItemClick(item)}>
              <View style={Styles.INSTANCE.barcodeDocumentFormats.listItemContainer}>
                <Text style={Styles.INSTANCE.barcodeDocumentFormats.listItemText}>
                  {item.key}
                </Text>
                <Switch
